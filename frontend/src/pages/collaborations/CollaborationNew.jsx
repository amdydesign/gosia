...
export default function CollaborationNew() {
    ...
    const handleAmountChange = (e) => {
        ...
        setFormData(prev => ({
            ...prev,
            [name]: value,
            // Auto-calculate gross if net changes (simple +23% logic or same if B2B/contract?)
            // User didn't specify logic, so let's just leave manual or simple clone
            amount_gross: name === 'amount_net' && !prev.amount_gross ? value : prev.amount_gross
        }));
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await apiRequest('/collaborations/create.php', 'POST', formData, token);
