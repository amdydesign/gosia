...
export default function IdeaView() {
    ...
    return (
        <div className="max-w-3xl mx-auto space-y-6">
            ...
            <div className="fixed bottom-12 left-0 right-0 p-4 bg-white border-t border-gray-200 md:static md:bg-transparent md:border-0 flex flex-row gap-3 z-10 safe-area-bottom shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
                <button
